...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/ttdefense

dist/Debug/GNU-Linux-x86/ttdefense: /usr/lib/libSDL.a

dist/Debug/GNU-Linux-x86/ttdefense: /usr/lib/libSDL_image.a
...
${OBJECTDIR}/AWG2dEntity.o: nbproject/Makefile-${CND_CONF}.mk AWG2dEntity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dEntity.o AWG2dEntity.cpp

${OBJECTDIR}/AWG2dTile.o: nbproject/Makefile-${CND_CONF}.mk AWG2dTile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dTile.o AWG2dTile.cpp

${OBJECTDIR}/AWG2dMap.o: nbproject/Makefile-${CND_CONF}.mk AWG2dMap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dMap.o AWG2dMap.cpp
...
${OBJECTDIR}/AWG2dEvent.o: nbproject/Makefile-${CND_CONF}.mk AWG2dEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dEvent.o AWG2dEvent.cpp

${OBJECTDIR}/AWG2dScrollAnim.o: nbproject/Makefile-${CND_CONF}.mk AWG2dScrollAnim.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dScrollAnim.o AWG2dScrollAnim.cpp

${OBJECTDIR}/AWG2dApp.o: nbproject/Makefile-${CND_CONF}.mk AWG2dApp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dApp.o AWG2dApp.cpp

${OBJECTDIR}/AWG2dSprite.o: nbproject/Makefile-${CND_CONF}.mk AWG2dSprite.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dSprite.o AWG2dSprite.cpp

${OBJECTDIR}/AWGVector.o: nbproject/Makefile-${CND_CONF}.mk AWGVector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWGVector.o AWGVector.cpp

${OBJECTDIR}/AWG2dAnimation.o: nbproject/Makefile-${CND_CONF}.mk AWG2dAnimation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AWG2dAnimation.o AWG2dAnimation.cpp
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/ttdefense
